report 50047 "Invoice Release For Payment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PaymentsonHold.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Supplier Invoice Release For Payment';
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            column(Released_On; "Released On") { }
    ...
    var
        ...
        Payments_on_HoldCaptionLbl: Label 'Supplier Invoice Release For Payment';
        ...
        Vend_NameCaptionLbl: Label 'Supplier Name';
